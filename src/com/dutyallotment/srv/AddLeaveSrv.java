...
/**
 * Servlet implementation class AddLeaveSrv
 */
@WebServlet("/AddLeaveSrv")
public class AddLeaveSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int flag = dao.addLeave(e_id, faculty_id);
		
		response.sendRedirect("addleave.jsp?status="+flag);
	}
